...
class Blog extends Component {
  ...
  getBlogItems() {
    ...
    axios
      .get(
        `https://hollybaker.devcamp.space/portfolio/portfolio_blogs?page=${this
          .state.currentPage}`,
        {
...
//         axios.get(`https://hollybaker.devcamp.space/portfolio/portfolio_blogs?page=${this.state.currentPage}`,
//         {withCredentials: true}
//         ).then(response => {
