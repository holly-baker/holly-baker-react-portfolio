...
export default class PortfolioForm extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            logo: "",
            editMode: false,
            apiUrl: "https://hollybaker.devcamp.space/portfolio/portfolio_items",
            apiAction: 'post'
        };
    ...
    componentDidUpdate() {
        if (Object.keys(this.props.portfolioToEdit).length > 0) {
            ...
            this.setState({
                ...
                url: url || "",
                editMode: true,
                apiUrl: `https://hollybaker.devcamp.space/portfolio/portfolio_items/${id}`,
                apiAction: "patch",
            ...
            <div className="image-uploaders three-column">
                ...
                {this.state.thumb_image_url && this.state.editMode ? (
                    ...
                    <DropzoneComponent 
                        ...
                        >
                            <div className="dz-message">Thumbmail Image</div>
                    </DropzoneComponent>
                )}
